...
class StudentsAttendanceReport(models.Model):
...
class StudentsLeaveReport(models.Model):
    id = models.AutoField(primary_key=True)
...
class StaffsLeaveReport(models.Model):
    id = models.AutoField(primary_key=True)
...
class StaffsNotification(models.Model):
    id = models.AutoField(primary_key=True)
